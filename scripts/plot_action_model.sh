...
#python multi_plots.py --result_dir "plots/action-model" --file_paths "experiment_data/action-model/total_losses_train.csv" "experiment_data/action-model/contrastive_losses_train.csv" "experiment_data/action-model/reconstruction_losses_train.csv" --smoothing_window 100 --step_resolution 1000
